  ...
  return (    <header className="bg-black/95 backdrop-blur-sm shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-2">          <div className="flex items-center space-x-3">
            ...
            <Search className="h-5 w-5 text-gray-300 cursor-pointer hover:text-amber-400" />            <Button className="bg-amber-400 hover:bg-amber-500 text-black font-medium px-4 py-2 rounded-none">
              Donate Now
            </Button>
