        ...
        <div className="grid md:grid-cols-4 gap-8 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="text-center group">
              <div className="bg-white w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg group-hover:shadow-xl transition-shadow duration-300 border-4 border-gray-100">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 w-20 h-20 bg-green-400 rounded-full opacity-60"></div>
            </div>
          </div>
        </div>
      </div>
